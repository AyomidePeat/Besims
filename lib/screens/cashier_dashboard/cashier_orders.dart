...
class CashierOrders extends ConsumerStatefulWidget {
  final double screenWidth;
  final String name;
  const CashierOrders({super.key, required this.screenWidth, required this.name});

  @override
  ConsumerState<CashierOrders> createState() => _CashierOrdersState();
}

class _CashierOrdersState extends ConsumerState<CashierOrders> {
  double space = 30;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      StreamBuilder(
          stream: cloudStoreRef.getCashierProducts(seller: widget.name),
